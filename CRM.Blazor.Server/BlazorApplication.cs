...
namespace CRM.Blazor.Server {
    public partial class CRMBlazorApplication : BlazorApplication {
        public CRMBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void CRMBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
